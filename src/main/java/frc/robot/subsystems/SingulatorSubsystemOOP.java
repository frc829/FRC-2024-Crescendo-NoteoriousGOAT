...
public class SingulatorSubsystemOOP extends SubsystemBase {

  private static final class Constants {
    private static final int deviceId = 25;
    private static final MotorType type = MotorType.kBrushless;
    private static final Measure<Voltage> kS = Volts.of(0.09107);
    private static final Measure<Per<Voltage, Velocity<Angle>>> kV = VoltsPerRadianPerSecond
        .of(0.00984245999068899135461930969448);
    private static final Measure<Per<Voltage, Velocity<Velocity<Angle>>>> kA = VoltsPerRadianPerSecondSquared
        .of(4.3258313532377152261982606884649e-4);
    private static final double kP = 1.0673248793628685007332882939288e-234;
    private static final double kI = 0.0;
    private static final double kD = 0.0;
    private static final double kFF = 8.589166666666666666666666666664e-5;
  ...
  public SingulatorSubsystemOOP() {
    ...
    canSparkFlex.setIdleMode(IdleMode.kBrake);
  ...
  private void stop() {
    if (RobotBase.isReal()) {
      ...
      dcMotorSim.setState(dcMotorSim.getAngularPositionRad(), 0);
    }
  }
