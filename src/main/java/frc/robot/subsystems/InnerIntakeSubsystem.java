...
public class InnerIntakeSubsystem extends SubsystemBase {
  ...
  public static final Supplier<InnerIntakeSubsystem> create = () -> {
    ...
    return new InnerIntakeSubsystem(
        spinner.voltage,
        spinner.velocity,
        spinner.spin,
        spinner.stop,
