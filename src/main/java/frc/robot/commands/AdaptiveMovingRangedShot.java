...
public class AdaptiveMovingRangedShot {
    public static final class Ranged {
        ...
        private static final BooleanSupplier shootersAtSpeed = () -> {
            boolean topCondition = topShooterSubsystem.atTolerance(Math.abs(Constants.topShooterPercent), Constants.shooterTolerancePercent);
            boolean bottomCondition = bottomShooterSubsystem.atTolerance(Math.abs(Constants.bottomShooterPercent), Constants.shooterTolerancePercent);
